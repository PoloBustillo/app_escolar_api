...
ALLOWED_HOSTS = ["localhost", "127.0.0.1","appescolarapi-production-56e4.up.railway.app","appescolarapi-production-b5ec.up.railway.app"]
INSTALLED_APPS = [
...
CORS_ALLOWED_ORIGINS = [
    ...
    'https://app-escolar-webapp-6b2u.vercel.app'
]
